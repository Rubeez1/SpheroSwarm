...
class Sphere:
    ...
    def __str__(self):
        return f"{self.id} {self.pos} {self.dest} {self.active} {self.population} {self.steps}"
    ...
    def sort_steps(self, populations):
        self.steps.sort(key=lambda step: populations[str(step)], reverse=True)
